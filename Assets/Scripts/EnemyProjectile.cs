...
public class EnemyProjectile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            ////lägger en force på rigidbodyn samt gör så att den är beroende av time.deltatime fast åt andra hållet mot ovan. Forcemode2D.impulse innebär att man får en force direkt när man callar den och inte någon gång mer
            rb.AddForce(Vector2.right * speed * Time.deltaTime, ForceMode2D.Impulse);
        }
        //förstör gameobjectet efter 1 sek
